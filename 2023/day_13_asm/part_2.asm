...
check_ver_mirrors:
  xor rdi, rdi                       ; rdi = number of smudges in reflection
  inc r14
  mov r15b, 10
...
check_single_ver_mirror:
  ...
  je ver_single_done
  jmp continue_single_ver_mirror
ver_single_done:
  cmp rdi, 1
  je ver_success
  jmp check_ver_mirrors

continue_single_ver_mirror:
...
check_single_hor_mirror:
  ...
  cmp rax, 0
  jl done_with_single_hor_mirror
  cmp r8, r13
  jge done_with_single_hor_mirror
  jmp continue_single_hor_mirror
done_with_single_hor_mirror:
  cmp rdi, 1
  je hor_success
  jmp check_hor_mirrors

continue_single_hor_mirror:
