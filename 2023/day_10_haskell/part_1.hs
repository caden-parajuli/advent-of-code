...
-- Determine the total length of the loop
findTotalLoopLen :: Array Int (Array Int Char) -> (Int, Int) -> Either String Int
findTotalLoopLen lines start = 
  ...
  case maybeFirstDir of
    ...
    Just firstDir ->
      ...
      findLoopLen firstPos firstDir 0
        where findLoopLen pos dir count =
                case posChar lines pos of
                      ...
                      case pipeDir char dir of
                        ...
                        Just newDir -> 
                          let newPos = goDir pos newDir in
                            findLoopLen newPos newDir (count + 1)
      
findFarthest :: Array Int (Array Int Char) -> Either String Int
findFarthest lines =
  case findStart lines of
    Nothing -> Left "Start not found"
    Just start -> case findTotalLoopLen lines start of
                    Left err -> Left err
                    Right loopLen -> Right (div loopLen 2)
